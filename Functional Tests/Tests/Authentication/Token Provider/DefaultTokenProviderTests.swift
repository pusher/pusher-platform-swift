...
class DefaultTokenProviderTests: XCTestCase {
    ...
    func testShouldRetrieveTokenFromTestTokenSerivce() {
        ...
        OHHTTPStubs.stubRequestsIfNeeded(passingTest: isPath(url.path)) { _ -> OHHTTPStubsResponse in
    ...
    func testShouldReportAnErrorWhenTokenRetrievalFailed() {
        ...
        OHHTTPStubs.stubRequestsIfNeeded(passingTest: isAbsoluteURLString(url.absoluteString)) { _ -> OHHTTPStubsResponse in
    ...
    func testShouldSetDefaultContentTypeHeader() {
        ...
        OHHTTPStubs.stubRequestsIfNeeded(passingTest: { request -> Bool in
